...
class NeedleHaystackTest {
    ...
    fun `should find a needle in the haystack`(haystack: String, needle: String, expectedLocation: Int) {
        Assertions.assertThat(strStrNaive(haystack, needle)).isEqualTo(expectedLocation)
        Assertions.assertThat(strStrNative(haystack, needle)).isEqualTo(expectedLocation)
    }
